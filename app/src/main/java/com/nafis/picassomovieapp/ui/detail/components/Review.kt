package com.nafis.movieapppicasso.ui.detail.components
...
import com.nafis.picassomovieapp.ui.components.CollapsibleText
...
fun ReviewItem(
    ...
    Column(modifier) {
        ...
        val ratingAnnotatedString = buildAnnotatedString {
            ...
            append(round(review.rating).toString()) // Round to nearest integer value
