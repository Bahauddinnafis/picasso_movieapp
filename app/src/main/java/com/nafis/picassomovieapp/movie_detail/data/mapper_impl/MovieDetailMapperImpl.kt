package com.nafis.picassomovieapp.movie_detail.data.mapper_impl

import com.nafis.picassomovieapp.common.data.ApiMapper
import com.nafis.picassomovieapp.movie_detail.data.remote.models.CastDto
...
class MovieDetailMapperImpl: ApiMapper<MovieDetail, MovieDetailDto> {
    ...
    override fun mapToDomain(apiDto: MovieDetailDto): MovieDetail {
        return MovieDetail(
            ...
            reviews = apiDto.reviewsDto?.results?.map {
                Review(
